 ...
 */
class AccidentMedia extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('accident_id, directory_name, filename, media_type', 'required'),
			array('accident_id', 'numerical', 'integerOnly'=>true),
			array('directory_name, filename', 'length', 'max'=>255),
			array('media_type', 'length', 'max'=>5),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, accident_id, directory_name, filename, media_type,image_type', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return AccidentMedia the static model class
	 */
