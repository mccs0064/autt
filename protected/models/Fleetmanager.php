 ...
 */
class Fleetmanager extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('email, password,first_name,last_name,picture,status', 'length', 'max'=>255),
	...
	public function relations()
	{
		...
		return array(
			'drivers' => array(self::HAS_MANY, 'Driver', 'fleetmanager_id'),
		);
	}
