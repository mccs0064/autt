...
class TrailerchecklistController extends Controller {
    ...
    public function actionIndex() {
        ...
        $this->pageTitle='Fleet Manager-Build Trailer Checklist';
        $items=TrailerChecklisFleet::model()->findAllByAttributes(array('fleetmanager_id'=>Yii::app()->user->id));
    ...
    public function actionAdd()
    {
        ...
        $model=new TrailerChecklisFleet();
    ...
    public function actionDelete()
    {
        ...
        $item=TrailerChecklisFleet::model()->findByPk($checklist_id);
