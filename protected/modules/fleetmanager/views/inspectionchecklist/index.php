...
<script>
    $("#add-btn").click(function () {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo Yii::app()->createUrl("fleetmanager/inspectionchecklist/add");?>',
        ...
        $(document.body).on("click", '.delete-item', function () {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo Yii::app()->createUrl("fleetmanager/inspectionchecklist/delete");?>',
