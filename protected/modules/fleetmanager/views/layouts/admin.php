...
<nav class="page-sidebar" data-pages="sidebar">
    ...
    <!-- START SIDEBAR MENU -->
        <?php $this->renderPartial('../layouts/partials/_sidebar_admin');?>
    <!-- END SIDEBAR MENU -->
</nav>
<!-- END SIDEBAR -->
<!-- END SIDEBPANEL-->
...
<div class="page-container ">
            ...
            <div class="pull-center hidden-md hidden-lg">
                <div class="header-inner">
                    <div class="brand inline">
                        <img src="<?php echo Yii::app()->request->baseUrl;?>/img/logo.png" alt="logo" data-src="<?php echo Yii::app()->request->baseUrl;?>/img/logo.png" data-src-retina="<?php echo Yii::app()->request->baseUrl;?>/img/logo_2x.png" width="78" height="22">
                    </div>
                </div>
            </div>
            <!-- RIGHT SIDE -->
        ...
        <div class=" pull-right">
            ...
            <div class="visible-lg visible-md m-t-10">
                <div class="pull-left p-r-10 p-t-10 fs-16 font-heading">
                    ...
                    <span class="semi-bold">Autium Administrator</span>
                </div>
                <?php
                ...
                <img src="<?php echo $picture_path;?>" alt="" data-src="<?php echo $picture_path;?>" data-src-retina="<?php echo Yii::app()->request->baseUrl;?>/img/profiles/avatar_small2x.jpg" width="32" height="32">
                    ...
                    <ul class="dropdown-menu profile-dropdown" role="menu">
                        <li class="bg-master-lighter">
                            <a href="<?php echo Yii::app()->request->baseUrl;?>/admin/login/logout" class="clearfix">
    ...
    <div class="page-content-wrapper ">
        ...
        <div class="content ">
            <!-- START JUMBOTRON -->
          <?php $this->renderPartial('../layouts/partials/_breadcrumbs_admin');?>
            <!-- END JUMBOTRON -->
