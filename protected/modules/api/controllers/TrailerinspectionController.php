...
class TrailerinspectionController extends InspectionreportController
{
    ...
    public function actionGetList()
    {
        ...
        $inspectionList=TrailerChecklisFleet::model()->findAllByAttributes(array('fleetmanager_id'=>$fleetmanager_id));
        $response=array();
    ...
    public function actionSave()
    {
        ...
        $model->submitted_date=new CDbExpression('NOW()');
        $model->due_date=new CDbExpression('NOW()');
        $model->status='Completed';
        $model->setScenario('Trailer');
        if($model->validate())
        {
            $model->save();
